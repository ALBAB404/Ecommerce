...
<div class="modal fade" id="modalCenter" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="modalCenterTitle">Show Colors</h5>
...
<div class="modal fade" id="editCenter" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modalCenterTitle">Edit Colors</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
@push('js')
    <script>
       ...
       const getAllCategory = () =>{
            axios.get('/admin/color/index').then((res)=>{
       ...
       const table_data_show = (colors) => {
        ...
        // Insert Method start
            $('#addCategoryForm').on('submit', function(e) {
                ...
                axios.post("/admin/color/store", data)
                    .then((res) => {
                        getAllCategory();
                        iziToast.success({
        ...
        $('body').on('click','.editBtn', function(e){
            ...
            let url = generateAdminURL("color") + slug
                ...
                <form action="" id="editCategoryForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                    class="bx bx-user"></i></span>
                            <input type="text" name="title" class="form-control" id="editTitle" value="${color.title}"
                                placeholder="John Doe" aria-label="John Doe"
                                aria-describedby="basic-icon-default-fullname2">
                        </div>
                    </div>
                    <div class="mb-3">
                    <input type="hidden" name="slug" id="editSlug" class="form-control"value="${color.slug}"
                        placeholder="john.doe" aria-label="john.doe"
        ...
        $('body').on('submit', '#editCategoryForm', function (e) {
            ...
            });  // Closing brace for the event handler function
     ...
     $('body').on('submit', '.deleteRow', function (e) {
                ...
                const url = generateAdminURL('color/delete') + slug;
                console.log(url);
