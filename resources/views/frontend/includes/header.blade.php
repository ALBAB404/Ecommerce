                ...
                <div class="ec-flex">
                    ...
                    <div class="align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{ asset('frontend') }}/assets/images/logo/logo-8.png" alt="Site Logo" /><img
                                    class="dark-logo" src="{{ asset('frontend') }}/assets/images/logo/dark-logo-8.png" alt="Site Logo"
