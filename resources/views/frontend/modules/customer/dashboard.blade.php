                            ...
                            <div class="col-md-12">
                                <div class="ec-vendor-block-profile">
                                    <div class="ec-vendor-block-img space-bottom-30">
                                        ...
                                        <div class="ec-vendor-block-detail">
                                            <img class="v-img" src="{{ asset('frontend') }}/assets/images/user/1.jpg" alt="vendor image">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="ec-vendor-detail-block ec-vendor-block-email space-bottom-30">
                                                <h6>E-mail address <a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{ asset('frontend') }}/assets/images/icons/edit.svg"
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="ec-vendor-detail-block ec-vendor-block-contact space-bottom-30">
                                                <h6>Contact nubmer<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{ asset('frontend') }}/assets/images/icons/edit.svg"
                                                    class="svg_img pro_svg" alt="edit" /></a></h6>
                                                <ul>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="ec-vendor-detail-block ec-vendor-block-address mar-b-30">
                                                <h6>Address<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{ asset('frontend') }}/assets/images/icons/edit.svg"
                                                    class="svg_img pro_svg" alt="edit" /></a></h6>
                                                <ul>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="ec-vendor-detail-block ec-vendor-block-address">
                                                <h6>Shipping Address<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{ asset('frontend') }}/assets/images/icons/edit.svg"
                                                    class="svg_img pro_svg" alt="edit" /></a></h6>
                                                <ul>
